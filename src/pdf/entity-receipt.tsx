...
export interface EntityReceiptProps {
...
const EntityReceipt: React.FC<{ receipt: EntityReceiptProps }> = ({ receipt }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.table}>
        <View style={styles.tableHeader}>
          ...
          <Text style={styles.tableHeaderCell}>Rate At Transaction</Text>
          <Text style={styles.tableHeaderCell}>Amount</Text>
        </View>
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>{receipt.entityName}</Text>
          <Text style={styles.tableCell}>{receipt.quantity}</Text>
          <Text style={styles.tableCell}>${(receipt.rateAtTransaction / 100).toFixed(2)}</Text>
      ...
      <View style={styles.totalsSection}>
        <View style={styles.totalRow}>
          ...
          <Text style={styles.totalValue}>${(receipt.totalAmount / 100).toFixed(2)}</Text>
        </View>
        <View style={styles.totalRow}>
